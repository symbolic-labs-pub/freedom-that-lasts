...
- [Event Sourcing Architecture](#event-sourcing-architecture)
  ...
  - [Data Flow](#data-flow)
  - [Tick Loop (Safeguard Evaluation)](#tick-loop-safeguard-evaluation)
- [Database Schema](#database-schema)
  - [Events Table (Append-Only)](#events-table-append-only)
  - [Projections Table](#projections-table)
- [Domain Model](#domain-model)
  - [Core Aggregates](#core-aggregates)
  - [Projections](#projections)
- [Safeguards](#safeguards)
  - [1. Delegation Concentration Detection](#1-delegation-concentration-detection)
  - [2. Law Checkpoint Enforcement](#2-law-checkpoint-enforcement)
  - [3. TTL Enforcement](#3-ttl-enforcement)
  - [4. Acyclic Graph Enforcement](#4-acyclic-graph-enforcement)
- [Idempotency](#idempotency)
  - [Command Idempotency](#command-idempotency)
  - [Event Replay Determinism](#event-replay-determinism)
...
- [Security Properties](#security-properties)
  ...
  - [Privacy](#privacy)
  - [Transparency Escalation](#transparency-escalation)
- [Extension Points](#extension-points)
  - [Custom Triggers](#custom-triggers)
  - [Custom Projections](#custom-projections)
  - [Custom Commands](#custom-commands)
- [Budget Module (v0.2)](#budget-module-v02)
  - [Design Philosophy](#design-philosophy-1)
  - [Budget Aggregate](#budget-aggregate)
  - [Flex Classes (Graduated Constraints)](#flex-classes-graduated-constraints)
  - [Multi-Gate Enforcement](#multi-gate-enforcement)
  - [Commands and Events](#commands-and-events)
  - [Projections](#projections-2)
  - [Invariants (100% Test Coverage)](#invariants-100-test-coverage)
  - [Triggers (Automatic Safeguards)](#triggers-automatic-safeguards)
  - [SafetyPolicy Extensions](#safetypolicy-extensions)
  - [CLI Commands](#cli-commands)
  - [Example Workflow](#example-workflow)
  - [Anti-Tyranny Properties](#anti-tyranny-properties)
  - [Testing Strategy](#testing-strategy-1)
- [Resources Module (v0.3)](#resources-module-v03)
  ...
  - [Concentration Monitoring](#concentration-monitoring)
  - [Tender Aggregate](#tender-aggregate)
  - [Commands and Events](#commands-and-events-1)
  - [Projections](#projections-3)
  - [Anti-Tyranny Properties](#anti-tyranny-properties-1)
- [Security & Hardening (v1.0)](#security--hardening-v10)
  - [Design Philosophy](#design-philosophy-3)
